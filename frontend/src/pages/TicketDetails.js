...
const styles = {
  cardWrapper: `flex justify-center mt-10`,
};
...
function TicketDetails() {
  ...
  const fetchTicket = async () => {
    try {
      const response = await axios.post(`http://localhost:4000/getTicket`, {
        ticketNo: tno,
      });
    ...
    <div className={styles.cardWrapper}>
      <div class="max-w-4xl p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="flex justify-between">
          <p class="mb-3 font-medium text-gray-700 dark:text-gray-400 underline">
            {tno}
          </p>
          <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 order-last">
            {ticketData?.date}
          </p>
        </div>
        <div className="flex flex-col justify-center">
          <p className="underline">Caller Information</p>
          <p className="font-bold text-gray-500 mt-1">{ticketData?.name}</p>
          <p className="font-medium text-gray-700 mt-1">{ticketData?.email}</p>
          <p className="font-medium text-gray-700 mt-1">{ticketData?.phone}</p>
          <p className="font-medium text-gray-600">
            {ticketData?.area} , {ticketData?.city}
          </p>
        </div>
        <a
          href="#"
